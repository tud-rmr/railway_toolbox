...
track1 = generateStraigthTrack(1,v_max,L);
track2 = generateTurnTrack(1,v_max,R,turn_in_deg);
track3 = generateStraigthTrack(1,v_max,L);
track_map = [track1;track2;track3];
